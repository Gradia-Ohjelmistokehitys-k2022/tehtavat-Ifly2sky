...
namespace T3.View
{
    ...
    public class Dwm
    {
        ...
        public enum DWMWINDOWATTRIBUTE : uint
        {
            ...
            DWMWA_WINDOW_CORNER_PREFERENCE = 33 // Set Corners manually in windows 11
        }
        ...
        public static void SetWindowCorners(IntPtr hWnd)
        {
            DWM_WINDOW_CORNER_PREFERENCE refer = DWM_WINDOW_CORNER_PREFERENCE.DWMWCP_ROUND;
            DwmSetWindowAttribute(hWnd, DWMWINDOWATTRIBUTE.DWMWA_WINDOW_CORNER_PREFERENCE, ref refer, sizeof(int));
        }
